  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Storing in localStorage for client-side logic
        localStorage.setItem("token", data.token);

        // Use window.location.href for a clean hand-off to the middleware
        setTimeout(() => {
  ...
  return (
    <>
      <div className="text-center mb-8">
        ...
        <p className="text-text/60">Sign in to your ROSCA account</p>
      </div>
        ...
        <div className="p-4 bg-primary/5 rounded-lg border border-primary/20">
          <div className="flex items-start space-x-2">
            ...
            <div className="text-sm">
              ...
              <p className="text-text/70">Email: demo@roasca.com</p>
              <p className="text-text/70">Password: demo123</p>
            </div>
          </div>
        </div>
      </form>
      ...
      <div className="mt-6 space-y-3">
        <button
          type="button"
          disabled={loading}
          onClick={handleGoogleLogin} // ✅ Linked the function here
          className="w-full py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors flex items-center justify-center space-x-2"
        >
